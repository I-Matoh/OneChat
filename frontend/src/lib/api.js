...
export const api = {
  ...
  conversations: {
    ...
    findOrCreateDM: (userId, workspaceId) => {
      const body = workspaceId ? JSON.stringify({ workspaceId }) : JSON.stringify({});
      return apiFetch(`/chat/conversations/dm/${userId}`, { method: 'POST', body });
    },
  },
